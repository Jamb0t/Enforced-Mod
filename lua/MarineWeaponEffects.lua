...
kMarineWeaponEffects =
{
    ...
    draw =
    {
        marineWeaponDrawSounds =
        {
			...
			{player_sound = "sound/compmod.fev/compmod/marine/hmg/hmg_draw", classname = "HeavyMachineGun", done = true},
    ...
    reload = 
    {
        gunReloadEffects =
        {
			...
			{player_sound = "sound/compmod.fev/compmod/marine/hmg/hmg_reload", classname = "HeavyMachineGun"},
    ...
    reload_cancel =
    {
        gunReloadCancelEffects =
        {
			...
			{stop_sound = "sound/compmod.fev/compmod/marine/hmg/hmg_reload", classname = "HeavyMachineGun"},
    ...
    release_napalm =
    {
        releaseNapalmEffects = 
        {
            {parented_cinematic = "cinematics/marine/grenades/napalm_explo.cinematic"},
            {sound = "sound/NS2.fev/marine/grenades/gas/explode"},
        },    
    },	
