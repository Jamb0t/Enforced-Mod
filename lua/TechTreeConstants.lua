...
local kTechIdTable = {
    ...
    'SentryBattery', 'PrototypeLab', 'AdvancedArmory', 'Electrify',
    
    // Weapon tech
    'AdvancedWeaponry', 'ShotgunTech', 'HeavyRifleTech', 'HeavyMachineGun', 'DetonationTimeTech', 'FlamethrowerRangeTech', 'GrenadeLauncherTech', 'FlamethrowerTech', 'FlamethrowerAltTech', 'WelderTech', 'MinesTech',
    'GrenadeTech', 'ClusterGrenade', 'ClusterGrenadeProjectile', 'GasGrenade', 'GasGrenadeProjectile', 'PulseGrenade', 'PulseGrenadeProjectile', 'NapalmGrenade', 'NapalmGrenadeProjectile',
    ...
    // onos abilities
    'Gore', 'Smash', 'Charge', 'BoneShield', 'Stomp', 'Shockwave', 'Doomsday', 
